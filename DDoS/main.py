...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            ...
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Attack Started On Target => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
...
def get_info_l4():
    ...
    port = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"VIP Network   "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"TIME(s)  "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    t = input()
...
def help():
    clear()
    stdout.write("             "+Fore.WHITE            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer7   "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX+" Show Layer7 Methods                    "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.WHITE            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer4   "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX+" Show Layer4 Methods                    "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.WHITE            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"tools    "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX+" Show tools                             "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.WHITE            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"credit   "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX+" Show more Information                            "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.WHITE            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX+" Exit DDoS                        "+Fore.LIGHTCYAN_EX+"\n")

    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write("")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Devloper "+Fore.RED+": \x1b[38;2;0;255;189mSelvador!\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Design "+Fore.RED+": \x1b[38;2;0;255;189mAnthony\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189mHamza DZ!\n")
    stdout.write("")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def layer4():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +" \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"OVH-bypass   "+Fore.LIGHTCYAN_EX+"-->"+Fore.RED+" OVH Attack                                "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +" \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"UDP-bypass   "+Fore.LIGHTCYAN_EX+"-->"+Fore.RED+" UDP Attack                                "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +" \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"DNS          "+Fore.LIGHTCYAN_EX+"-->"+Fore.RED+" DNS Attack                                "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +" \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"TCP-bypass   "+Fore.LIGHTCYAN_EX+"-->"+Fore.RED+" TCP Attack                                "+Fore.LIGHTCYAN_EX+"\n")
    stdout.write("\n")
##############################################################################################
def tools():
    clear()
...
##############################################################################################
def title():
    stdout.write("             "+Fore.LIGHTCYAN_EX+" "+Fore.LIGHTWHITE_EX   +""+Fore.LIGHTCYAN_EX +"\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+" "+Fore.LIGHTWHITE_EX   +"if you need help use [help]"+Fore.LIGHTCYAN_EX +" \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+" "+Fore.LIGHTWHITE_EX   +"To Know Layer4 Methods use [L4]"+Fore.LIGHTCYAN_EX +"       \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+" "+Fore.LIGHTWHITE_EX   +"To Know Layer7 Methods use [L7]"+Fore.LIGHTCYAN_EX +"       \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+" "+Fore.LIGHTWHITE_EX   +"To Know More Information use [credits]"+Fore.LIGHTCYAN_EX +"       \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+""+Fore.LIGHTWHITE_EX   +"To Know Tools Net Use  [tools]"+Fore.LIGHTCYAN_EX +"       \n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+""+Fore.RED+"Mortem "+Fore.RED+""+Fore.RED+"qBot"+Fore.CYAN+"-->"+Fore.LIGHTCYAN_EX+""+Fore.WHITE)
    command = input()
